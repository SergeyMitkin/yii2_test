...
$requirements = array(
    ...
    array(
        ...
        'by' => '<a href="http://www.yiiframework.com/doc-14.0/yii-caching-memcache.html">MemCache</a>',
        'memo' => extension_loaded('memcached') ? 'To use memcached set <a href="http://www.yiiframework.com/doc-14.0/yii-caching-memcache.html#$useMemcached-detail">MemCache::useMemcached</a> to <code>true</code>.' : ''
    ),
    // CAPTCHA:
    array(
        ...
        'mandatory' => false,
        'condition' => $gdOK,
        'by' => '<a href="http://www.yiiframework.com/doc-14.0/yii-captcha-captcha.html">Captcha</a>',
        'memo' => $gdMemo,
    ),
    array(
...
if (!version_compare(phpversion(), '5.5', '>=')) {
    $requirements[] = array(
        ...
        'by' => '<a href="http://www.yiiframework.com/doc-14.0/yii-caching-apccache.html">ApcCache</a>',
    );
}
