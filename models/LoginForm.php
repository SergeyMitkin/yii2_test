...
class LoginForm extends Model
{
    ...
    public function rules()
    {
        return [
            ...
            [['username'], 'required', 'message' => 'Необходимо заполнить «' . $this->getAttributeLabel('username'). '»'],
            [['password'], 'required', 'message' => 'Необходимо заполнить «' . $this->getAttributeLabel('password'). '»'],
